"""
Level 05: Cryptography
Phase 2 - Month 5: Crypto & Steg
"""
import os
import sys
...
def run(state: dict, defender_callback=None) -> bool:
    ...
    # level_05 corresponds to mission_id 501
    mission_id = 501
    ...
    print(f"\033[2mThe arena is live. An intercepted message is hosted on port 80.\033[0m\n")
