"""
Level 01: The Network Recon
Phase 1 - Month 1: Networking Basics
"""
import os
import sys
...
def run(state: dict, defender_callback=None) -> bool:
    ...
    # level_01 corresponds to mission_id 101
    mission_id = 101
    ...
    print(f"\033[2mThe arena is live. Start your attack.\033[0m\n")
