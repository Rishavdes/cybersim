"""
Level 10: Web Application Exploitation
Phase 2 - Month 8: Web Security
"""
import os
import sys
...
def run(state: dict, defender_callback=None) -> bool:
    ...
    # level_10 corresponds to mission_id 801
    mission_id = 801
    ...
    print(f"\033[2mThe arena is live. Web application is running on port 80.\033[0m\n")
